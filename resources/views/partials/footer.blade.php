    ...
    <div class="container mx-auto pt-20 sm:pt-52">
        ...
        <div class="flex flex-col sm:flex-row justify-center">
            ...
            <div class="flex flex-col flex-1 justify-center mb-10 sm:mb-0">
                <ul id="footer-menu" class=''>
                    ...
                    <li>ΣυνταγΕς</li>
                    <li>Blog</li>
                    <li>Βρειτε τα κοντα σας</li>
                    <li>Η Καλλιεργειες μας</li>
            ...
            <div class="flex flex-col flex-1">
                ...
                <ul>
                    <li>Διεύθυνση: Θέση Ντριζακούκι, Αυλώνας, Αττικής</li>
                    <li>Τηλέφωνο: +30 2295041870</li>
                    <li>Email: contactus@aroma-herbs.com</li>
                </ul>
            </div>
        ...
        <div class="flex sm:justify-end border-b-2 border-light-green items-center h-28">
            ...
            <ul class='flex' id="socials">
                ...
                <li class="text-light-green"><i class="fab fa-instagram fa-2x"></i></li>
            </ul>
