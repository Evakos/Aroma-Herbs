...
<nav class="container absolute mx-auto right-0 left-0 top-0 flex items-center justify-between flex-wrap md:pt-12 lg:pt-20 scroll">
...
<img src="@field('hero_image')" alt="Hero Image" class="object-cover w-screen min-h-[300px] md:min-h-[600px]"/> 
@endfield
</div>
